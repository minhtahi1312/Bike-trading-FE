    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-[#111813] dark:text-white font-display">
      ...
      <main className="flex-1 w-full max-w-[1200px] mx-auto px-4 md:px-10 py-8">
        ...
        <div className="flex flex-col gap-4">
          {/* Item 1 */}
          <div className="group bg-surface-light dark:bg-surface-dark rounded-xl border border-primary/40 dark:border-primary/30 p-4 md:p-5 shadow-sm hover:shadow-md transition-all duration-200">
          ...
          {/* Item 4 */}
          <div className="opacity-75 hover:opacity-100 transition-opacity bg-surface-light dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-700 p-4 md:p-5 shadow-sm">
            <div className="flex flex-col md:flex-row gap-5">
              <div className="shrink-0 relative">
        ...
        <div className="mt-8 flex justify-center">
          <nav className="flex items-center gap-2">
            <button className="size-9 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50">
              <span className="material-symbols-outlined text-sm">chevron_left</span>
            </button>
            <button className="size-9 flex items-center justify-center rounded-lg bg-primary text-background-dark font-bold text-sm">1</button>
            <button className="size-9 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 text-[#111813] dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800 text-sm font-medium">2</button>
            <button className="size-9 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 text-[#111813] dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800 text-sm font-medium">3</button>
            <span className="text-gray-400">...</span>
            <button className="size-9 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800">
